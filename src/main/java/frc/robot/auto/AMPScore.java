...
public class AMPScore extends SequentialCommandGroup {
    public AMPScore(boolean yinverted, DriveSubsystem driveSubsystem, GangedMotorSubsystem gc, Trajectories trajectories) {
        double invert = 1.0;
        ...
        addCommands(
            new DriveStraightCommand("AMP Score Midpoint", driveSubsystem, firstPose, Constants.MAX_VELOCITY, Constants.SLOW_VELOCITY, 270.0),
            new DriveStraightCommand("AMP Score at AMP", driveSubsystem, secondPose, Constants.MAX_VELOCITY, Constants.SLOW_VELOCITY, 270.0),
